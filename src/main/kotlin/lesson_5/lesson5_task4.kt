...
fun main() {
    ...
    if (name == enterName) {
        ...
        println("Такого пользователя не существует, Вам требуется пройти процедуру регистрации.")
        return
    }
    ...
    if (password == enterPassword) {
        ...
        """
        [вздыхает очень грубоко...] Ну вот, сожалею, Ваш пароль не подходит, попробуйте в другой раз ...
        хотя ... мне уже будет всё равно, подойдет он или нет ... 
    """.trimIndent()
    )
}
